...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "g11_cdiofinal" because\n';
  ...
  $wnd.__gwt_activeModules['g11_cdiofinal'] = {
    'moduleName' : 'g11_cdiofinal',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/g11_cdiofinal.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['g11_cdiofinal'].superdevmode = true;

  var expectedSuffix = '/g11_cdiofinal.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + g11_cdiofinal + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:g11_cdiofinal';
  var devModeSessionKey = '__gwtDevModeSession:g11_cdiofinal';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/g11_cdiofinal/g11_cdiofinal.nocache.js';
  ...
  $wnd.__gwt_activeModules['g11_cdiofinal'].canRedirect = true;
  $wnd.__gwt_activeModules['g11_cdiofinal'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING g11_cdiofinal';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/g11_cdiofinal?user.agent=' + ua + '&_callback=' + callback;
